...
| Track H (veilgremlin multi-harness proxy plan — Codex support) | **Plan merged 2026-09-14** (veilgremlin PR #74). **D-BETA-8 ratified 2026-09-14: condition 1 now requires Codex parity (Track H's H0-H4), not Claude-only** — reopens the 2026-09-13 beta-bar ratification. Scoped as intent `INT-2026-09-14-001` (H1+H2b+H2c, first slice). **H2b (codec trait extraction) BUILT 2026-09-15** — veilgremlin `docs/decisions.md`'s 2026-09-15 entry; fork F4 (header-forwarding policy) decided as part of it. H2c and H1 not yet started. H0 remains blocked on A3, which has not landed. | `docs/decisions.md` 2026-09-14 D-BETA-8 entry; `.hekton/intents/INT-2026-09-14-001/intent.yaml`; `veilgremlin/docs/architecture/multi-harness-proxy-plan.md` §4/§7; `veilgremlin/docs/decisions.md` 2026-09-15 entry. |
